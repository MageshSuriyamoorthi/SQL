...
select Customer.FirstName,Customer.lastName,[Order].TotalAmount from Customer Inner Join [Order]
ON Customer.Id=[Order].CustomerId

select customer.supplierId,customer.firstname,customer.lastname,product.isDiscontinued from customer inner join product
on customer.id=product.id where isDiscontinued=0 
